...
#define DATE_UNIT_SIZE (_settings_client.gui.time_in_minutes ? _settings_game.economy.ticks_per_minute : DAY_TICKS)
...
#define CURRENT_MINUTE ((((DateTicks)_date * DAY_TICKS) + _date_fract) / _settings_game.economy.ticks_per_minute)
