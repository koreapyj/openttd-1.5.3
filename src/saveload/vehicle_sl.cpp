...
const SaveLoad *GetVehicleDescription(VehicleType vt)
{
	...
	static const SaveLoad _common_veh_desc[] = {
		...
		SLEG_CONDVAR(         _cargo_loaded_at_xy,   SLE_UINT32,                  51,  67),
		 ...
		 SLE_CONDREF(Vehicle, ahead_separation,      REF_VEHICLE,                200, SL_MAX_VERSION),
		 SLE_CONDREF(Vehicle, behind_separation,     REF_VEHICLE,                200, SL_MAX_VERSION),
		...
		SLE_CONDNULL(4,                                                           69, 100),
		 ...
		 SLE_CONDVAR(Vehicle, current_loading_time,  SLE_UINT32,                 200, SL_MAX_VERSION),
